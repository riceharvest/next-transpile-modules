...
- **Original Repository**: https://github.com/martpie/next-transpile-modules.git
...
- clone
- `cd @opensourceframework/next-transpile-modules`
- `yarn`
...
Please make sure to [read the changelog](https://github.com/martpie/@opensourceframework/next-transpile-modules/releases).
...
So you are probably [using it wrong](https://github.com/martpie/@opensourceframework/next-transpile-modules/issues/5#issuecomment-441501107), and I advice you to use `npm` or Yarn workspaces instead.
...
It can happen that when using `@opensourceframework/next-transpile-modules` with a local package and `npm`, you end up with duplicated dependencies in your final Next.js build. It is important to understand _why_ it happens.
